...
How should we make inference on population importance?
--

1. construct regression estimators (e.g., with machine learning)

--

2. compute simple, initial estimator 
--
  ...but this estimator has .red[asymptotic bias]
--

3. use influence function-based debiasing [e.g., Pfanzagl (1982)] to obtain corrected estimator 

--

**Key observation:** estimator from (3) arises from steps 1 and 2 with a different parameter of interest

This implies .blue1[no need for debiasing]! .small[[Details in Williamson et al. (2020a)]]
...
1. Choose a relevant measure of .blue1[predictiveness] $V$ for the task at hand
...
2. Define variable importance as $$V( \text{best possible prediction function using all variables}) - $$ $$V(\text{best possible prediction function excluding the variables of interest})$$
...
## Transition to EDI work

Placeholder text about how I want to make the academic space more welcoming, equitable, inclusive

How I've focused on outreach while at the Hutch
